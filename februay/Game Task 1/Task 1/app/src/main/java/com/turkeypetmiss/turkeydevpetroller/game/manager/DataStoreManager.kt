...
object DataStoreManager: AbstractDataStore() {
    ...
    object DataPokupki: DataStoreElement<String>() {
        override val key = stringPreferencesKey("DataLevel")
    }
    object IsTutorial: DataStoreElement<Boolean>() {
        override val key = booleanPreferencesKey("IsTutorial")
    }
    object Gold: DataStoreElement<Int>() {
        override val key = intPreferencesKey("Gold")
    }
    object Gel: DataStoreElement<Int>() {
        override val key = intPreferencesKey("Gel")
    }
